    ...
    <div className="plate shadow-plate w-full max-w-md rounded-2xl p-14">
        ...
        {TABS.map(tab => {
          ...
          return (
            <button
              ...
              onClick={() => onNetworkChange(tab.id)}
              className={[
      ...
      {network === 'ktmb' ? (
        <p className="mt-12 font-sans text-caption leading-snug text-sage-mute">
          Semua tren KTM yang aktif ditunjukkan pada kedudukan GPS sebenar. KTM
          tiada penapisan per-laluan.
        </p>
      ) : (
        <div className="mt-12">
          {/* Search input */}
          ...
          {/* Route list */}
          <div className="scrollbar-none mt-10 max-h-64 overflow-y-auto">
            {routesLoading ? (
