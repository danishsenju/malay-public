...
const ms = {
  ...
  'search.filter.penang': 'Penang',
  'search.filter.mrtfeeder': 'Feeder MRT',
  'search.filter.alorSetar': 'Alor Setar',
  'search.filter.kt': 'K. Terengganu',
  'search.filter.ipoh': 'Ipoh',
  'search.filter.serembanA': 'Seremban A',
  'search.filter.serembanB': 'Seremban B',
  'search.filter.melaka': 'Melaka',
  'search.filter.kuching': 'Kuching',
  ...
  'map.pickNetwork': 'Pilih rangkaian',
  'map.searchRoute': 'Cari laluan - cth. U2510, PJ01, Sunway',
  'map.searchRouteAria': 'Cari laluan bas',
  'map.stop': 'Hentian',
  'map.gpsAgo': 'lalu',
  ...
  'card.liveAria': 'Data langsung',
  'card.staleAria': 'Data mungkin lewat',
  'network.bus': 'RapidKL',
  'network.rail': 'Rel',
  'network.ktmb': 'KTM',
  'network.johor': 'myBAS Johor',
  'network.penang': 'Rapid Penang',
  'network.mrtfeeder': 'Bas Feeder MRT',
  'network.alorSetar': 'myBAS Alor Setar',
  'network.kualaTerengganu': 'myBAS K. Terengganu',
  'network.ipoh': 'myBAS Ipoh',
  'network.serembanA': 'myBAS Seremban A',
  'network.serembanB': 'myBAS Seremban B',
  'network.melaka': 'myBAS Melaka',
  'network.kuching': 'myBAS Kuching',

  // ── KTM page ───────────────────────────────────────────────────────────────
  'ktmb.updated': 'Dikemas kini',
  'ktmb.eyebrow': 'Jadual KTM',
  'ktmb.title.1': 'Jadual tren',
  'ktmb.title.2': 'KTM.',
  'ktmb.intro': 'Tren pertama, tren akhir dan bilangan stesen untuk setiap laluan Komuter, ETS & Intercity - terus daripada GTFS rasmi, bukan tekaan.',
  'ktmb.stale': 'Data mungkin lewat',
  'ktmb.buyTicket': 'Beli tiket KTM rasmi',
  'ktmb.official': 'Rasmi',
  'ktmb.loadFailed': 'Jadual tak dapat dimuatkan sekarang.',
  'ktmb.loadFailedDesc': 'Sumber jadual di data.gov.my mungkin tumbang. Cuba muat semula sebentar lagi - status penuh setiap suapan ada di',
  'ktmb.empty': 'Tiada jadual KTM buat masa ini.',
  'ktmb.emptyDesc': 'Jadual belum dimuat naik ke pangkalan data. Jalankan',
  'ktmb.emptyDesc2': 'untuk mengisinya.',
  'ktmb.lines': 'laluan',
  'ktmb.stat.first': 'Pertama',
  'ktmb.stat.last': 'Akhir',
  'ktmb.stat.stations': 'Stesen',
  'ktmb.stat.trips': 'Trip/hari',
  'ktmb.footnote': 'Waktu berjadual MYT · jadual GTFS statik · kedudukan tren langsung di',

  // ── Report page ────────────────────────────────────────────────────────────
  'report.title.1': 'Laporan',
  'report.title.2': 'Harian.',
  'report.intro': 'Siapa lambat hari ini? Gred dikira daripada suapan langsung data.gov.my - bukan kenyataan akhbar. Nombor hari ini, gred purata 7 hari.',
  'report.noData': 'Belum cukup data',
  'report.grade': 'Gred',
  'report.notEnough': 'Belum cukup sampel',
  'report.learning': 'lejar sedang belajar',
  'report.stalled': 'tren tersekat',
  'report.noVehicles': 'min tiada kenderaan',
  'report.outage': 'min suapan putus',
  'report.cleanDay': 'hari yang bersih ✓',
  'report.empty': 'Lejar baru mula merekod. Semak semula sebentar lagi - setiap pelawat membantu kami sampel suapan.',
  'report.unmonitored': 'Tidak dipantau',
  'report.unmonitoredDesc': 'Prasarana tidak menyiarkan kedudukan tren LRT / MRT / Monorel secara langsung. Kami tak boleh gred apa yang mereka tak tunjukkan.',
  'report.statusLink': 'Semak status suapan langsung',
  'report.statusLinkDesc': 'Kesihatan setiap sumber data.gov.my, masa nyata',
  'report.methodology': 'Metodologi: kami sampel setiap suapan ± seminit · uptime = % sampel upstream menjawab · tren tersekat = tiada pergerakan > 6 minit · lejar penuh boleh disemak di',

  // ── Status page ────────────────────────────────────────────────────────────
  'status.checked': 'Disemak',
  'status.allOk.1': 'Semua sistem',
  'status.allOk.2': 'berjalan.',
  'status.problem.1': 'Ada sumber',
  'status.problem.2': 'bermasalah.',
  'status.intro': 'Kami bukan sumber data - data.gov.my yang siarkan suapan ini. Bila ia bermasalah, anda patut tahu bezanya antara “aplikasi rosak” dan “sumber tumbang”.',
  'status.noResponse': 'tiada respons dalam 6s',
  'status.fail': 'GAGAL',
  'status.slow': 'PERLAHAN',
  'status.ok': 'OK',
  'status.latestSamples': 'Sampel lejar terkini',
  'status.vehicles': 'kenderaan',
  'status.minAgo': 'min lalu',
  'status.openIncidents': 'Insiden terbuka sekarang',
  'status.since': 'sejak',
  'status.event.stall': 'tren tersekat',
...
const en: Record<StringKey, string> = {
  ...
  'search.filter.johor': 'Johor',
  'search.filter.penang': 'Penang',
  'search.filter.mrtfeeder': 'MRT Feeder',
  'search.filter.alorSetar': 'Alor Setar',
  'search.filter.kt': 'K. Terengganu',
  'search.filter.ipoh': 'Ipoh',
  'search.filter.serembanA': 'Seremban A',
  ...
  'map.pickNetwork': 'Choose network',
  'map.searchRoute': 'Search routes - e.g. U2510, PJ01, Sunway',
  'map.searchRouteAria': 'Search bus routes',
  'map.stop': 'Stop',
  'map.gpsAgo': 'ago',
  ...
  'card.liveAria': 'Live data',
  'card.staleAria': 'Data may be delayed',
  'network.bus': 'RapidKL',
  'network.rail': 'Rail',
  'network.ktmb': 'KTM',
  'network.johor': 'myBAS Johor',
  'network.penang': 'Rapid Penang',
  'network.mrtfeeder': 'MRT Feeder Bus',
  'network.alorSetar': 'myBAS Alor Setar',
  'network.kualaTerengganu': 'myBAS Kuala Terengganu',
  'network.ipoh': 'myBAS Ipoh',
  'network.serembanA': 'myBAS Seremban A',
  'network.serembanB': 'myBAS Seremban B',
  'network.melaka': 'myBAS Melaka',
  ...
  'ktmb.title.1': 'KTM train',
  'ktmb.title.2': 'timetable.',
  'ktmb.intro': 'First train, last train and station count for every Komuter, ETS & Intercity line - straight from the official GTFS, not guesswork.',
  'ktmb.stale': 'Data may be delayed',
  'ktmb.buyTicket': 'Buy official KTM tickets',
  'ktmb.official': 'Official',
  'ktmb.loadFailed': "Couldn't load the timetable right now.",
  'ktmb.loadFailedDesc': 'The timetable source at data.gov.my may be down. Try reloading shortly - full feed status is at',
  'ktmb.empty': 'No KTM timetable available yet.',
  'ktmb.emptyDesc': "The timetable hasn't been loaded into the database. Run",
  'ktmb.emptyDesc2': 'to populate it.',
  'ktmb.lines': 'lines',
  'ktmb.stat.first': 'First',
  'ktmb.stat.last': 'Last',
  'ktmb.stat.stations': 'Stations',
  'ktmb.stat.trips': 'Trips/day',
  'ktmb.footnote': 'Scheduled times MYT · static GTFS timetable · live train positions at',

  'report.title.1': 'Daily',
  'report.title.2': 'Report.',
  'report.intro': "Who's late today? Grades are computed from live data.gov.my feeds - not press releases. Today's numbers, 7-day average grade.",
  'report.noData': 'Not enough data',
  'report.grade': 'Grade',
  'report.notEnough': 'Not enough samples',
  'report.learning': 'the ledger is still learning',
  'report.stalled': 'stalled trains',
  'report.noVehicles': 'min with no vehicles',
  'report.outage': 'min of feed outage',
  'report.cleanDay': 'a clean day ✓',
  'report.empty': 'The ledger just started recording. Check back shortly - every visitor helps us sample the feeds.',
  'report.unmonitored': 'Not monitored',
  'report.unmonitoredDesc': "Prasarana doesn't publish live LRT / MRT / Monorail train positions. We can't grade what they don't show.",
  'report.statusLink': 'Check live feed status',
  'report.statusLinkDesc': 'Health of every data.gov.my source, in real time',
  'report.methodology': 'Methodology: we sample every feed about once a minute · uptime = % of samples where upstream responded · stalled train = no movement > 6 minutes · the full ledger is at',

  'status.checked': 'Checked',
  'status.allOk.1': 'All systems',
  'status.allOk.2': 'running.',
  'status.problem.1': 'Some sources',
  'status.problem.2': 'have problems.',
  'status.intro': "We're not the data source - data.gov.my publishes these feeds. When they have problems, you deserve to know the difference between “the app is broken” and “the source is down”.",
  'status.noResponse': 'no response within 6s',
  'status.fail': 'FAIL',
  'status.slow': 'SLOW',
  'status.ok': 'OK',
  'status.latestSamples': 'Latest ledger samples',
  'status.vehicles': 'vehicles',
  'status.minAgo': 'min ago',
  'status.openIncidents': 'Open incidents right now',
  'status.since': 'since',
  'status.event.stall': 'stalled train',
